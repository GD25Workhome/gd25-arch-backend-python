...
访问 `http://127.0.0.1:8090/` 时返回 **404 Not Found** 错误。
...
**没有定义根路径 `/` 的路由**，所以访问 `http://127.0.0.1:8090/` 时，FastAPI 找不到匹配的路由，返回 404。
...
**效果**：
- 访问 `http://127.0.0.1:8090/` 会返回欢迎信息和可用端点列表
- 用户可以通过根路径了解 API 结构
...
**效果**：
- 访问 `http://127.0.0.1:8090/` 会自动跳转到 `http://127.0.0.1:8090/admin`
...
- ✅ `http://127.0.0.1:8090/` - 根路径（返回欢迎信息）
- ✅ `http://127.0.0.1:8090/health` - 健康检查
- ✅ `http://127.0.0.1:8090/version` - 版本信息
- ✅ `http://127.0.0.1:8090/admin` - 管理界面
- ✅ `http://127.0.0.1:8090/docs` - API 文档
- ✅ `http://127.0.0.1:8090/api/v1/users` - 用户 API
